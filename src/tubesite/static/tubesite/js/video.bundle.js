...
if(!(TO_PRIMITIVE in proto))__webpack_require__(11)(proto, TO_PRIMITIVE, __webpack_require__(197));
...
function pageLoad() {
    ...
    if (video_model['extra']) {
        var extra = JSON.parse(video_model['extra']);
        var playlist = extra.videos.map(function (x) {
            return {
                poster: x.poster,
